...
async function seed() {
  try {
    ...
    console.log('Users: 2 (admin / user, password: secret123)');
    console.log('Datasets: 1 (Features Demo)');
    console.log('Branches: 2 (main, feature/update-features)');
    console.log('Commits: 3');
    console.log('Spatial Features: 9');
    console.log('Merge Requests: 1 (with MODIFY_MODIFY conflict on point-001)');
